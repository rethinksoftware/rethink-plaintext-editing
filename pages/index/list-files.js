...
All code and assets for this challenge live under pages/index/.
...
Once complete, email a .zip of clean, tested code to will@rethink.software. It will be run using npm i && npm run dev.
